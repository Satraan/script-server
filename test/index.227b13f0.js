...
`,W=u.forwardRef(((e,t)=>{var{as:n,children:a,className:r,variant:i="contained",size:s="medium"}=e,m=o(e,["as","children","className","variant","size"]);return u.createElement(z,l({as:n,ref:t,className:r,variant:i,size:s},m),a)})),D=d.div`
...
`,fe=d(he)`
  top: 24px;
`,be=v.default?v.default:v,ge=({onSubmit:e,formData:t,loading:n})=>{const[a,r]=u.useState(""),[o,i]=u.useState("");function s(e){return e?/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(e)?null:"Not a valid email format":"Required"}function m(e){if(!e)return"Required";switch(e.slice(0,2)){case"27":if(e.length<11)return"Too short";if(e.length>11)return"Too long";break;case"25":if(e.length<12)return"Too short";if(e.length>12)return"Too long";break;case"23":if(e.length<10)return"Too short";if(e.length>10)return"Too long"}return null}function c(e){if(!e)return"Required";if(e.length<3)return"Too short";if(e.length>124)return"Too long";return new RegExp(/^[^&%$#@!+=<>/\|,±§]+$/).test(e)?null:"Not allowed &%$#@!+=<>/\\|,±§"}function d(e){if(!e)return null;return new RegExp(/^[^%$#]+$/).test(e)?null:"Not allowed %$#"}return w((()=>{(e=>{const t={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e})};if(!e)return null;fetch("https://aaepmikbh8.execute-api.eu-west-1.amazonaws.com/dev/contact/validate",t).then((e=>e.json())).then((e=>{r(e.Status.result.suggestion)}))})(o)}),500,[o]),u.createElement(y,{initialValues:t,onSubmit:t=>e(t)},(({setFieldValue:e,errors:r,touched:o,setTouched:p})=>u.createElement(G,null,u.createElement(U,null,u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"firstName"},"First name"),u.createElement(N,{id:"firstName",name:"firstName",placeholder:"John",type:"text",variant:"outlined",component:Q,validate:c,InputProps:{endAdornment:u.createElement(M,{position:"end"},r.firstName&&o.firstName?u.createElement(de,null,u.createElement(S,null)):null)}})),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"lastName"},"Last name"),u.createElement(N,{id:"lastName",name:"lastName",placeholder:"Smith",type:"text",variant:"outlined",component:Q,validate:c,InputProps:{endAdornment:u.createElement(M,{position:"end"},r.lastName&&o.lastName?u.createElement(de,null,u.createElement(S,null)):null)}}))),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"role"},"Role"),u.createElement(N,{id:"role",name:"role",variant:"outlined",select:!0,component:Q},me.map((e=>u.createElement(le,{key:e.value,value:e.value},e.label))))),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"contactNumber"},"Business contact number"),u.createElement(ue,{hasErrors:r.contactNumber&&o.contactNumber},u.createElement(N,{id:"contact-number",name:"contactNumber",autocomplete:"tel",placeholder:"82 123 4567",disabled:n,type:"tel",country:"za",onlyCountries:["za","ke","mu"],value:t.contactNumber,component:be,validate:m,autoFormat:!0,countryCodeEditable:!1,masks:{za:".. ... ....",mu:". ... ...",ke:"... ... ..."},onBlur:()=>{p(l(l({},o),{contactNumber:!0}))},onChange:t=>{e("contactNumber",t)}}),u.createElement(pe,null,r.contactNumber&&o.contactNumber?u.createElement(M,{position:"end"},u.createElement(de,null,u.createElement(S,null))):u.createElement(M,{position:"end"},u.createElement(C,null))),u.createElement(he,null,r.contactNumber&&o.contactNumber&&u.createElement("p",null,r.contactNumber)))),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"email"},"Business contact email"),u.createElement(N,{id:"email",name:"email",placeholder:"email@address.co.za",type:"text",variant:"outlined",onChange:t=>{i(t.target.value),e("email",t.target.value)},component:Q,validate:s,InputProps:{endAdornment:u.createElement(M,{position:"end"},r.email&&o.email?u.createElement(de,null,u.createElement(S,null)):u.createElement(I,null))}}),!r.email&&o.email&&a&&u.createElement(fe,null,u.createElement("p",null,"Did you mean ",a,"?"))),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"businessName"},"Business name (optional)"),u.createElement(N,{id:"businessName",name:"businessName",placeholder:"Peach Payments",type:"text",variant:"outlined",component:Q,validate:d,InputProps:{endAdornment:u.createElement(M,{position:"end"},r.businessName&&o.businessName?u.createElement(de,null,u.createElement(S,null)):null)}})),u.createElement(Z,null,u.createElement(W,{theme:H,type:"submit",disabled:n},"Next ",n?u.createElement(R,{size:14}):u.createElement(B,null))))))},xe=L({businessWebsite:O().matches(/[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&\/\/=]*)/,"Invalid format")});function Ee(e){if(!e)return null;return new RegExp(/^[^%$#]+$/).test(e)?null:"Not allowed %$#"}const ve=({onSubmit:e,handleBack:t,formData:n,loading:a})=>u.createElement(y,{initialValues:n,validationSchema:xe,onSubmit:t=>{e(t)}},(({errors:e,touched:n,values:r})=>u.createElement(G,null,u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"businessWebsite"},"Business website URL (optional)"),u.createElement(N,{id:"businessWebsite",name:"businessWebsite",placeholder:"www.peachpayments.co.za",type:"text",variant:"outlined",component:Q,InputProps:{endAdornment:u.createElement(M,{position:"end"},e.businessWebsite&&n.businessWebsite?u.createElement(de,null,u.createElement(S,null)):null)}})),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"looking-for"},"What are you looking for?"),u.createElement(N,{id:"looking-for",name:"lookingFor",variant:"outlined",select:!0,component:Q},ie.map((e=>u.createElement(le,{key:e.value,value:e.value},e.label))))),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"trading-volume"},"Trading Volume"),u.createElement(N,{id:"trading-volume",name:"tradingVolume",variant:"outlined",select:!0,component:Q},se.map((e=>u.createElement(le,{key:e.value,value:e.value},e.label))))),u.createElement(k,null,u.createElement($,{shrink:!0,htmlFor:"extra-info"},"How else can we help you?"),u.createElement(N,{id:"extra-info",name:"extraInfo",placeholder:"Tell us how we can help your business thrive",type:"text",rows:7,multiline:!0,variant:"outlined",component:Q,validate:Ee})),u.createElement(Z,null,u.createElement(Y,{theme:H,color:"primary",type:"button",onClick:()=>t(r),disabled:a},u.createElement(F,null)," Back")," ",u.createElement(W,{theme:H,color:"primary",type:"submit",disabled:a},"Get Started! ",a&&u.createElement(R,{size:14})))))),we=d.div`
  min-height: 555px;
  display: flex;
  flex-direction: column;
...
`,je=({showUserFeedback:e,setShowUserFeedback:t,customWidth:n})=>{const a=(e,n)=>{"clickaway"!==n&&t(!1)};return u.createElement(Ae,{open:e,autoHideDuration:5e3,onClose:a,customWidth:n},u.createElement(te,{onClose:a,severity:"warning"},"An error has occurred. Please try submitting the form again or refresh the page."))},Te=()=>{const[e,t]=u.useState(!1),[n,a]=u.useState(),[r,o]=u.useState(!1),[i,s]=u.useState("step-one"),[m,c]=u.useState({email:"",firstName:"",lastName:"",businessName:"",businessWebsite:"",contactNumber:"",lookingFor:"Shopify",role:"owner",tradingVolume:"Less than R50 000",extraInfo:"",id:""}),d=decodeURIComponent(window.location.search.substring(1)).split("&");return u.createElement(D,null,u.createElement(je,{showUserFeedback:e,setShowUserFeedback:t,customWidth:"step-one"!==i&&"step-two"!==i}),"step-one"===i&&u.createElement(ge,{onSubmit:e=>{let n={};ce.forEach((e=>{const t=(e=>{for(let t=0;t<d.length;t++){let n=d[t].split("=");if(n[0]===e)return null===n[1]?null:n[1]}})(e);null!=t&&""!=t&&null!=t&&(n[e]=t)})),t(!1),o(!0),c(l(l(l({},m),e),n)),(e=>{const n={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)};fetch("https://aaepmikbh8.execute-api.eu-west-1.amazonaws.com/dev/contact/create",n).then((e=>{if(e.ok)return e.json();throw new Error("Something went wrong. Please try again.")})).then((e=>(a(e.userId),o(!1),s("step-two"),e))).catch((e=>{o(!1),t(!0)}))})(l(l(l({},m),e),n))},formData:m,loading:r}),"step-two"===i&&u.createElement(ve,{onSubmit:e=>{const a=e.businessWebsite.replace(/^https?\:\/\//i,"");let r={hutk:"",pageName:document.title,pageUri:document.URL};const i=document.cookie.match(new RegExp("(^| )hubspotutk=([^;]+)"));i&&i.length>0&&(r.hutk=i[2]),o(!0),t(!1),c(l(l(l({},m),e),{businessWebsite:a})),(e=>{const n={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)};fetch("https://aaepmikbh8.execute-api.eu-west-1.amazonaws.com/dev/contact/submit",n).then((e=>{if(e.ok)return e.json();throw new Error("Something went wrong. Please try again.")})).then((e=>(o(!1),s("success"),e))).catch((e=>{o(!1),t(!0)}))})(l(l(l(l({},m),e),r),{businessWebsite:a,id:n}))},handleBack:e=>{c(l(l({},m),e)),s("step-one")},formData:m,loading:r}),"success"===i&&u.createElement(Be,{email:m.email,setActiveStep:s,resendEmail:()=>{const e={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:m.email})};fetch("https://aaepmikbh8.execute-api.eu-west-1.amazonaws.com/dev/contact/resubmitemail",e).then((e=>{if(e.ok)return s("update-email-success"),e.json();throw new Error("Something went wrong. Please try again.")})).catch((e=>{t(!0)}))}}),"update-email"===i&&u.createElement(Se,{formSnapshotData:m,setActiveStep:s,handleUpdateContact:e=>{o(!0),c(l(l({},m),e));const a={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l(l({},e),{id:n}))};fetch("https://aaepmikbh8.execute-api.eu-west-1.amazonaws.com/dev/contact/update",a).then((e=>{if(o(!1),e.ok)return s("update-email-success"),e.json();throw new Error("Something went wrong. Please try again.")})).catch((e=>{t(!0)}))},loading:r}),"update-email-success"===i&&u.createElement(Fe,null),("step-one"===i||"step-two"===i)&&u.createElement(_,null,"Just like you, we hate spam. We'll only use your personal information to administer your account and to provide the products and services you requested from us."))},Ve=d.div`
  display: flex;
  justify-content: center;
